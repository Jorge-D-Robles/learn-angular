  ...
  steps: [
    ...
    },
    {
      ...
      narrativeText:
        ...
        'as an Observable, and you subscribe to receive the data when it arrives.',
      code: [
      ...
      explanation:
        ...
        'you get type safety, so TypeScript knows directives is MissionDirective[], not unknown. ' +
    ...
    },
    {
      ...
      explanation:
        '.post<T>(url, body) sends the body as JSON, and Angular sets the Content-Type header for you. ' +
    ...
    },
    {
      ...
      conceptBody:
        ...
        '.delete<T>(). Each returns an Observable that emits the response body. Requests are lazy, so ' +
      ...
      keyPoints: [
        'HttpClient methods return typed Observables, so you get compile-time safety on response data',
        'Requests are lazy (cold observables), and subscribing triggers the actual HTTP call',
        'POST, PUT, and DELETE bodies are auto-serialized as JSON with the right Content-Type',
        'Add provideHttpClient() to your app config to enable it, just one line of setup',
      ],
    },
  ],
  completionCriteria: {
