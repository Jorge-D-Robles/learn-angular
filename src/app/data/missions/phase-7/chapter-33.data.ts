...
export const CHAPTER_33_CONTENT: StoryMissionContent = {
  ...
  steps: [
    ...
    },
    {
      ...
      explanation:
        'trigger() names the animation, and you bind it to a template element with [@doorState]. ' +
        'state() captures what each state looks like (its CSS snapshot). transition() says when to ' +
        'animate, and the "closed <=> open" shorthand means both directions. animate() controls the ' +
    ...
    },
    {
      ...
      explanation:
        ...
        'removes the element. Without this, the alert would just pop in and vanish with no visual cue ' +
