  ...
  steps: [
    ...
    },
    {
      ...
      narrativeText:
        ...
        'figures out the dependencies automatically, so you don\'t declare them anywhere. And the result is ' +
      ...
      explanation:
        ...
        'returns a cached value with no recomputation and no waste.',
    },
    {
      stepType: 'code-example',
      narrativeText:
    ...
    },
    {
      ...
      conceptBody:
        ...
        'computed() holds state that\'s calculated from other signals. It runs lazily, so the derivation ' +
    ...
    },
    {
      ...
      hints: [
        ...
        'Define status = computed(() => { ... }), then read this.temperature() and this.pressure() inside, and return \'CRITICAL\' or \'NOMINAL\' based on the thresholds',
      ],
